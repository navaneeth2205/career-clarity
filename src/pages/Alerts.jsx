	...
	return (
		<section className="space-y-4">
			<div className="cc-surface p-6 sm:p-8">
				<h1 className="cc-heading text-2xl font-extrabold text-slate-900">Alerts</h1>
			...
			{isLoading ? (
				...
				<div className="grid gap-3">
					{alerts.map((alert) => (
						<article key={alert.id} className="rounded-xl border border-indigo-100 bg-gradient-to-br from-white to-indigo-50/40 p-4 shadow-sm">
